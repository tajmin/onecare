    ...
    return (
        <div className="flex flex-1 flex-col xl:flex-row border-1 hover:shadow-lg rounded-lg bg-white space-y-4 pb-8 xl:pb-0">
            ...
            <div className="px-6 text-left">
                ...
                <button className="bg-pink-400 px-5 py-2 xl:ml-56 mt-2 xl:mt-0 xl:mt-1 text-white">Details <ChevronRightIcon className="inline-block w-6 animate-ping"></ChevronRightIcon></button>
            </div>
